...
project_name='TV_sales' # this is the project name which i have given as 'mlproject_with_mlflow', usually we create one folder called src inside that src folder it will create 'mlproject_with_mlflow' inside this folder we all create all of the components 
